...
- [ ] **HN-02**: Each HN card shows title, points, comment count, author, and published date
- [ ] **HN-03**: Each HN card links to original HN discussion
...
- [ ] **RDT-02**: Each Reddit card shows title, upvotes, comment count, subreddit, author, and published date
- [ ] **RDT-03**: Each Reddit card links to original Reddit post
...
- [ ] **SOC-01**: All social posts stored in normalized SocialPost model (platform + external_id + title + url + author + score + comment_count + published_at)
...
| RDT-02 | Phase 2 | Pending |
| RDT-03 | Phase 2 | Pending |
