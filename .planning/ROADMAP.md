...
- [ ] **Phase 1: Foundation + GitHub Pipeline** - SQLite WAL mode, shared HTTP client, GitHub API end-to-end with real chart data
...
|-------|----------------|--------|-----------|
| 1. Foundation + GitHub Pipeline | 2/3 | In Progress|  |
